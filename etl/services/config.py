...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+psycopg://weightbox_admin:change_me@db:5432/weightbox"
    )
    # Plain libpq DSN, used by the psycopg connection
    pg_dsn: str = Field(
        default="postgresql://weightbox_admin:change_me@db:5432/weightbox"
    )
    ...
    @classmethod
    def _dsn_is_libpq(cls, v: str) -> str:
        if "+psycopg" in v:
